...
export class DatasetComponent implements OnInit, AfterViewInit {
  ...
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////
  class_array={1:"Sun",2:"Flower",3:"Pencil",4:"Tree",5:"Bird",6:"House",7:"Mug",8:"Umbrella",9:"Spoon",10:"Hand"}
  className:string =" ";
  present:string=" ";

  update_classname(element:any){
    this.className=this.class_array[element];
    this.present="Present Selection: "
  }
  ...
  saveImage(){
    if(this.className===null){
      alert("PLease select a class from available options.")
      return;
    }
    const MyCanvas: HTMLCanvasElement = this.canvas.nativeElement;
    var date =Date.now();
